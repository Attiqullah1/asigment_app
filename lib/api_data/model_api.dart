...
List<ModelPrayer> modelPrayerFromJson(String str) => List<ModelPrayer>.from(json.decode(str).map((x) => ModelPrayer.fromJson(x)));

String modelPrayerToJson(List<ModelPrayer> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
